<div class="panel panel-default">
    <div class="panel-body">
        <div class="row" data-field="booking-container">
            <div class="col-md-6" data-field="calendar-select">
                <div class="form-group">
                    <label>Kies Workout Agenda *</label>
        ...
        <div class="row" data-field="spark-cup">
            <div class="col-md-12">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" name="isSparkCup"> SPARK cup
                    </label>
                </div>
            </div>
        </div>
